...
public class SmartDashboardCommand extends CommandBase {
    ...
    protected void execute() {
    	...
    	SmartDashboard.putNumber("Pitch: ", driveTrain.getNavXRoll()); // This depends on orientation of the RoboRIO
    	SmartDashboard.putNumber("Roll: ", driveTrain.getNavXPitch()); // This depends on orientation of the RoboRIO
