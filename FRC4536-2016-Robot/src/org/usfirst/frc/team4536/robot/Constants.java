...
public class Constants {
	...
	public static final double SPEED_CURVE_TURN = 1.5;
	public static final double SPEED_CURVE = 2.4;
	public static final double SPEED_LIMIT = 1;
	public static final double ACCEL_LIMIT_DRIVE = 0.1;
	public static final double ACCEL_LIMIT_INTAKE = 0.1;
	...
	public static final double PICK_UP_BALL_TIME_OUT = 0.1;
