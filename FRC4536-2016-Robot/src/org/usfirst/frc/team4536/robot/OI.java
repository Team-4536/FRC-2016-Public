...
public class OI {
	...
	public static Button wheelieStomp;
	...
	public static void buttonHandling () {
		...
		wheelieStomp = new JoystickButton(mainStick, 12);
		...
		wheelieStomp.whenPressed(new WheelieStomp());
		...
		wheelieStomp.whenReleased(new DriveAccelLimited());
	}
}
